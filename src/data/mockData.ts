...
export const AGENTS: AgentInfo[] = [
  {
    id: 'extract',
    name: '추출 에이전트 (Extract Agent)',
    emoji: '🔵',
    color: 'blue',
    description: '에이전트 대기 중',
    runningDescription: 'PDF 구조 분석 및 개인정보(일반·민감·고유식별) 항목 추출 중...',
    status: 'pending',
    durationMs: 8000,
  },
  {
    id: 'generation',
    name: '생성 에이전트 (Generation Agent)',
    emoji: '🟣',
    color: 'purple',
    description: '에이전트 대기 중',
    runningDescription: '수집 항목 기반 개인정보보호법 맞춤형 동의서 조항 작성 중...',
    status: 'pending',
    durationMs: 10000,
  },
  {
    id: 'audit',
    name: '감사 에이전트 (Audit Agent)',
    emoji: '🟢',
    color: 'emerald',
    description: '에이전트 대기 중',
    runningDescription: '개인정보보호법 조항 대조 및 법적 위반·위험 요소 감사 중...',
    status: 'pending',
    durationMs: 8000,
  },
];
